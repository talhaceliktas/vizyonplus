...
export default function DuyuruTab({ settings, setSettings }: SettingsState) {
  return (
      ...
      <SectionBox title="Global Site Duyurusu">
        ...
        {settings.duyuruAktif && (
          <div className="space-y-4">
            ...
            <div
              className={`mt-4 rounded-md p-3 text-center text-sm font-medium transition-colors ${
            ...
            >
              ÖNİZLEME: {settings.duyuruMetni || "Metin girilmedi..."}
            </div>
          </div>
        )}
      </SectionBox>
