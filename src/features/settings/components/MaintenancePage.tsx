/**
 * Bu bileşen, site bakım modundayken kullanıcılara gösterilen tam ekran kapatma sayfasıdır.
 * Görsel efektler ve animasyonlar içerir.
 */
...
const MaintenancePage = () => {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="absolute top-0 -z-10 h-px w-full bg-linear-to-r from-transparent via-white/10 to-transparent" />
      ...
      <div className="relative z-10 flex max-w-3xl flex-col items-center px-6 text-center">
        ...
        {/* Başlık */}
        <h1 className="mb-8 bg-linear-to-b from-white to-white/60 bg-clip-text pb-4 text-5xl font-extrabold tracking-tight text-transparent sm:text-7xl">
          Sahne Arkasındayız
        </h1>
        ...
        {/* Alt Bilgi */}
        <div className="flex items-center gap-3 rounded-full border border-white/5 bg-white/2 px-4 py-2 text-sm text-gray-500 backdrop-blur-md">
      ...
      <div className="absolute bottom-0 w-full">
        <div className="h-px w-full bg-linear-to-r from-transparent via-red-900/40 to-transparent" />
        <div className="h-[100px] w-full bg-linear-to-t from-red-900/5 to-transparent" />
      </div>
    </div>
  );
};
